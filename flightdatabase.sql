...
INSERT INTO PURCHASES (purchaseId, loungeAccess, creditCardNumber, creditCardSecurityCode, totalPurchaseCost, ticketInsurance, flightId, customerId, useCompanionVoucher) VALUES
('P001', TRUE, '1111222233334444', 123, 500, FALSE, 101, 1001, FALSE),
('P002', FALSE, '4444333322221111', 456, 800, TRUE, 100, 1001, FALSE),
('P003', TRUE, '2222333344445555', 789, 300, FALSE, 100, 1003, FALSE);
